...
const ForgetPasswordPage: FC = (): ReactElement => {
    const [email, setEmail] = useState("");
    const [isSubmitted, setIsSubmitted] = useState(false);
    const { isLoading, forgetPassword } = useAuthState();
                ...
                {!isSubmitted ? (
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-300 mb-6">
                            If an account with the {email} address exists, you
                            will receive an email with instructions to reset
                            your password.
                        </p>
                    </div>
                )}
